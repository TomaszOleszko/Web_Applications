...
include_once 'C:\xampp\htdocs\Lab11\klasy\Baza.php';
echo "<h1>Formularz zamówienia</h1>";
echo drukuj_form();
...
if (filter_input(INPUT_POST, "submit")) {
    ...
    switch ($akcja) {
        case "Dodaj" : dodajdoBD($bd);
            break;
        case "Pokaż" : echo $bd->select("select * from klienci",
            ["Email", "Zamowienie"]);
            break;
        case "PHP" :
            echo pokaz_Zamowienie("PHP",$bd);
            break;
        case "CPP" :
            echo pokaz_Zamowienie("CPP",$bd);
            break;
        case "Java" :
            echo pokaz_Zamowienie("Java",$bd);
            break;
